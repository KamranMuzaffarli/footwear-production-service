...
async def list_construction_methods(
    ...
    statement = (
        select(ShoeConstructionMethod)
        .order_by(ShoeConstructionMethod.construction_method_id)
    )
...
async def list_material_categories(
    ...
    statement = (
        ...
        .order_by(MaterialCategory.material_category_id)
    )
...
async def list_material_usage_roles(
    ...
    statement = (
        select(MaterialUsageRole)
        .order_by(MaterialUsageRole.material_usage_role_id)
    )
